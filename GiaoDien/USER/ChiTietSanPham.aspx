<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ChiTietSanPham.aspx.cs" Inherits="BTLWebCoBan.GiaoDien.USER.ChiTietSanPham" %>
...
<body>
    <form id="formChiTietSanPham" runat="server">
         <%---------------------------------------------HEADER----------------------------------------------------------%>
<header class="header">
    <div class="logo">
    ...
    <section id="sp-detail" class="section-p1">
        <div class="single-pro-image">
            <img runat="server" src="" id="MainImg" name="MainImg" alt="Anh tai nghe">
        </div>
        <div class="sp-info">
            <h4 runat="server" id="tensp" name="tensp">Ten San Pham</h4>
            <hr>
            <h2 runat="server" id="giasp" name="giasp">Gia San Pham</h2>
            <input type="number" id="soluong" runat="server" name="soluong" value="1" >
            <button class="sp-button" type="button" runat="server" onserverclick="ThemVaoGioHang">Thêm vào giỏ hàng</button>
    ...
    <section id="sp-relative" class="section-p1">
        ...
        <section id="product1" class="section_1">
            ...
            <div id="SanPhamLienQuan" runat="server" class="big_container">
